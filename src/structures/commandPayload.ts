...
export class CommandPayload {
    ...
    private _nameLocalizations?: { [key: string]: string };
    private _description?: string;
    private _descriptionLocalizations?: { [key: string]: string };
    private _options?: any[];
    private _defaultMemberPermissions?: string;
     ...
     */
    set nameLocalizations(value: { [key: string]: string } | undefined) {
     ...
     */
    set descriptionLocalizations(value: { [key: string]: string } | undefined) {
