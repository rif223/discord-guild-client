...
export class GuildChannel {
   ...
   */
  public async sendMessage(options: MessagePayload | object): Promise<any> {
    ...
    try {
      ...
      const data = await this._client.rest.request(
        ...
        apiEndpoints.guildChannelMessages(this.id),
        options
      );
   ...
   */
  public async create(options: ChannelPayload | object): Promise<any> {
   ...
   */
  public async edit(options: ChannelPayload | object): Promise<GuildChannel> {
    let channelPayload: ChannelPayload;
    ...
    try {
      ...
      const data = await this._client.rest.request(
        ...
        apiEndpoints.guildChannel(this.id),
        payload
      );
